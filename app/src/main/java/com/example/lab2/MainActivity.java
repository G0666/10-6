...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_winner = findViewById(R.id._winner);
        ...
        btn_mora.setOnClickListener(view -> {
            ...
            if (ed_name.length() < 1) {
                ...
                int computer_ramdon = (int) (Math.random() * 3);

                if (computer_ramdon == 0) {
                    tv_cmora.setText("電腦出拳\n剪刀");
                } else if (computer_ramdon == 1) {
                    tv_cmora.setText("電腦出拳\n石頭");
                } else {
                    tv_cmora.setText("電腦出拳\n布");
                }

                if ((btn_scissor.isChecked() && computer_ramdon == 2) ||
                ...
                } else if ((btn_scissor.isChecked() && computer_ramdon == 1) ||
